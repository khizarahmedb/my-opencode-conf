# Opencode Agent Setup Instructions (macOS/Linux)

## Overview

This guide sets up opencode-specific agent configuration in your environment. It extends the base [agents-config](https://github.com/khizarahmedb/agents-config) with opencode-specific features like MCP servers and enhanced context retrieval.
